...
MAX_STEPS = 1000
BATCH_SIZE = 1
GRADIENT_ACCUMULATION_STEPS = 4  # Reduced for Apple Silicon
LEARNING_RATE = 2e-4
DEVICE = "mps" if torch.backends.mps.is_available() else "cpu"

print(f"Loading processor and model... (using device: {DEVICE})")
...
# Training config optimized for Apple Silicon
training_args = SFTConfig(
    ...
    save_total_limit=2,
    bf16=False,
    fp16=False,  # MPS doesn't support mixed precision training well
